...
EODAG__COP_DATASPACE__AUTH__CREDENTIALS__USERNAME="${11:-${EODAG__COP_DATASPACE__AUTH__CREDENTIALS__USERNAME:-somepw}}"
EODAG__COP_DATASPACE__AUTH__CREDENTIALS__PASSWORD="${12:-${EODAG__COP_DATASPACE__AUTH__CREDENTIALS__PASSWORD:-somepw}}"
EODAG__USGS__API__CREDENTIALS__USERNAME="${13:-${EODAG__USGS__API__CREDENTIALS__USERNAME:-somepw}}"
EODAG__USGS__API__CREDENTIALS__PASSWORD="${14:-${EODAG__USGS__API__CREDENTIALS__PASSWORD:-somepw}}"
